...
<header id="home_header_wrapper">
 ...
 <section id="content-wrapper">
   ...
   <form name="loginForm" action="loginCust" method="post">
     <table border="0" align="center" cellpadding="10">
      <tr><th colspan="2" align="center"><h3>Log In to Priyakart<h3></h1></th></tr>
      <tr><td>Username </td>
      <td><input type="text" name="custId" placeholder="Email Address or Phone NO."></td></tr> 
      <tr><td>Password </td>
      <td><input type="password" name="password" placeholder="Password"></td></tr>
      <tr><td colspan="2" align="center"><input type="submit" name="LogIn"  size="60" value="Log In"></td></tr>
     </table>
   </form>
    <p align="center"><a href="regCons">New to Priyakart? SignUp</a></p> 
